        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card" style="width: 100%;">
                    <div class="card-header">Додати нового хореографа</div>
                    <div class="card-body">
                    <div class="page">
                        ...
                        <form method="POST" action="{{ url('/admin/choreographers') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @include ('admin.choreographers.form', ['formMode' => 'create'])
                        </form>
