        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card" style="width: 100%;">
                    <div class="card-header">Додати новий конкурс</div>
                    <div class="card-body">
                    <div class="page">
                        ...
                        <form method="POST" action="{{ url('/admin/conquers') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @include ('admin.conquers.form', ['formMode' => 'create'])
                        </form>
