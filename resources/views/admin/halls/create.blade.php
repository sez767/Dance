        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 100%;">
                    <div class="card-header">Додати нову залу</div>
                    <div class="card-body">
                    <div class="page">
                        ...
                        @endif
                        <form method="POST" action="{{ url('/admin/halls') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @include ('admin.halls.form', ['formMode' => 'create'])
                        </form>
                    </div>
                </div>
            </div>
