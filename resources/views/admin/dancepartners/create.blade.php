        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 100%;">
                    <div class="card-header">Додати нового партнера</div>
                    <div class="card-body">
                        <div class="page">
                            ...
                            <div class="container">
                                ...
                                <form method="POST" action="{{ url('/admin/dancepartners') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    @include ('admin.dancepartners.form', ['formMode' => 'create'])
                                </form>
                            </div>    
                        </div>
                    </div>      
